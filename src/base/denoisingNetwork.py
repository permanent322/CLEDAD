...
class diff_Block(nn.Module):
    """
    A neural network block that incorporates diffusion embedding, designed for the reverse pass in DDPM. It corresponds to the denoising block in the CLEDAD architecture.
